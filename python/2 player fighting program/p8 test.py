...
def battle(fighters):
    ...
    while True:
        ...
        selection1 = input(f"it is {fighters['name1']} turn, which ability would you like to pick? ({fighters['attack1a']}, or {fighters['attack1b']})  ")
        ...
        if health1 <= 0:
            print(f"GGs, {fighters['name1']} wins! with {health2} remaining!")
            break
        else:
            pass
        if health2 <=0:
            print(f"GGs, {fighters['name2']} wins! with {health2} remaining!")
            break
        else:
            pass
        
        #ask fighter 2 for input
        selection2 = input(f"it is {fighters['name2']} turn, which ability would you like to pick? ({fighters['attack2a']}, or {fighters['attack2b']})   ")
